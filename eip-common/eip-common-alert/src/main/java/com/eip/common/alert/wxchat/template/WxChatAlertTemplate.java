package com.eip.common.alert.wxchat.template;
 ...
 * @version V1.0.0
 */
public class WxChatAlertTemplate {
     ...
     * 服务上下线通知文本
     */
    public static final String WX_CHART_SERVER_NOTIFY_TXT =
            "<font color='info'>【**通知**】 </font>服务上下线变更动态通知 \n\n" +
                    " \n\n " +
                    "<font color='comment' size=14>服务环境：【**%s**】</font> \n\n " +
                    "<font color='comment' size=14>服务名称：%s</font> \n\n " +
                    "<font color='comment' size=14>服务实例：%s</font> \n\n " +
                    "<font color='warning' size=14>服务状态：%s</font> \n\n " +
                    "<font color='comment' size=14>服务地址：%s</font> \n\n " +
                    " \n\n  " +
                    "<font color='comment' size=14>提醒：**@%s**</font> \n\n" +
                    "<font color='comment' size=14>  提示：服务上下线变更实时通知（无限制）</font> \n\n" +
                    " \n\n  " +
                    "**播报时间：%s**";
     ...
     * 线程池报警通知文本
     */
    public static final String WX_CHART_THREAD_ALARM_TXT =
     ...
     * 线程池参数变更通知文本
     */
    public static final String WX_CHART_THREAD_NOTICE_TXT =
