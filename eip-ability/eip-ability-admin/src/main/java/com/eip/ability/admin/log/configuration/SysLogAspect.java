//package com.eip.ability.admin.log.configuration;
//
//
...
//import com.eip.ability.admin.log.LogUtil;
//import com.eip.ability.admin.log.SysLog;
//import com.eip.ability.admin.log.event.SysLogEvent;
...
//     * 标记了@SysLog 注解的方法
//     */
//    @Pointcut("execution(public * com.eip..*.*(..)) && @annotation(com.eip.ability.admin.log.SysLog)")
