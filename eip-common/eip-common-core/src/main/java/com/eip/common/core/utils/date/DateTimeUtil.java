package com.eip.common.core.utils.date;
...
public class DateTimeUtil {
    ...
    public static LocalTime parseTime(String time, String pattern) {
        BaseResponseEnum.DATE_NOT_NULL.assertNotEmpty(time);
    ...
    private static String checkNotEmpty(String time, boolean nullable) {
        ...
        if (!nullable) {
            BaseResponseEnum.DATE_NOT_NULL.assertFail(time);
        }
    ...
    private static DateTimeFormatter getFormatter(String pattern) {
        BaseResponseEnum.PATTERN_NOT_NULL.assertNotEmpty(pattern);
    ...
    public static List<LocalDate> getBetween(LocalDate startDate, LocalDate endDate) {
        ...
        LocalDate tmpDate = DateTimeUtil.clone(startDate);
    ...
    public static long getBetweenSeconds(LocalDateTime startDateTime, LocalDateTime endDateTime) {
        BaseResponseEnum.DATETIME_NOT_NULL.assertNotNull(startDateTime);
        BaseResponseEnum.DATETIME_NOT_NULL.assertNotNull(endDateTime);
    ...
    public static long getBetweenSeconds(LocalTime startTime, LocalTime endTime) {
        BaseResponseEnum.TIME_NOT_NULL.assertNotNull(startTime);
        BaseResponseEnum.TIME_NOT_NULL.assertNotNull(endTime);
