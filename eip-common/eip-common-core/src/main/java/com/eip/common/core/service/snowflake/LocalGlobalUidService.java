package com.eip.common.core.service.snowflake;
 ...
 * @类名称 LocalGlobalUidService.java
...
@Slf4j
@Component
public class LocalGlobalUidService {
     ...
     */
    public LocalGlobalUidService(long workerId, long datacenterId) {
    ...
    public static void main(String[] args) {
        LocalGlobalUidService worker =  new LocalGlobalUidService();
        for (int i = 0; i < 10; i++) {
            long id = worker.nextId();
            System.out.println(id);
            System.out.println(worker.parseUID(id));
        }
    }
}