package com.eip.common.alert.lark.template;
 ...
 * @version V1.0.0
 */
public class LarkAlertTemplate {
     ...
     * 线程池报警通知文本
     */
    public static final String LARK_THREAD_ALARM_TXT =
     ...
     * 线程池参数变更通知文本
     */
    public static final String LARK_THREAD_NOTICE_TXT =
