...
import com.eip.base.lock.strategy.impl.ClusterConfigImpl;
import com.eip.base.lock.strategy.impl.MasterslaveConfigImpl;
import com.eip.base.lock.strategy.impl.SentinelConfigImpl;
import com.eip.base.lock.strategy.impl.StandaloneConfigImpl;
...
public class RedissonManager {
    ...
    static class RedissonConfigFactory {
        ...
        Config createConfig(RedissonProperties redissonProperties) {
            ...
            if (connectionType.equals(RedissonMode.STANDALONE.getConnection_type())) {
                redissonConfigService = new StandaloneConfigImpl();
            } else if (connectionType.equals(RedissonMode.SENTINEL.getConnection_type())) {
                redissonConfigService = new SentinelConfigImpl();
            } else if (connectionType.equals(RedissonMode.CLUSTER.getConnection_type())) {
                redissonConfigService = new ClusterConfigImpl();
            } else if (connectionType.equals(RedissonMode.MASTERSLAVE.getConnection_type())) {
