package com.eip.ability.gateway.config.rule;

import cn.hutool.core.collection.CollectionUtil;
import cn.hutool.core.util.IdUtil;
import com.alibaba.fastjson.JSON;
import com.eip.ability.gateway.rest.domain.BlacklistRule;
import com.eip.ability.gateway.rest.domain.LimitRule;
...
import static com.eip.ability.gateway.config.rule.GatewayRule.Constants.DEFAULT_RULE_LIMIT_TOTAL;
import static com.eip.ability.gateway.config.rule.GatewayRule.Constants.GLOBAL_RANGE;
import static com.eip.ability.gateway.config.rule.GatewayRule.GatewayRuleEnum.RULE_LIMIT;
