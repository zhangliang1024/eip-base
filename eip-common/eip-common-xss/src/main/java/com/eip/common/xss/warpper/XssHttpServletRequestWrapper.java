package com.eip.common.xss.warpper;

import com.eip.common.xss.filter.HTMLFilter;
import com.eip.common.xss.filter.SQLFilter;
...
public class XssHttpServletRequestWrapper extends HttpServletRequestWrapper {
    ...
    private String xssEncode(String input) {
        ...
        return htmlFilter.filter(SQLFilter.filter(input));
    }
