...
import com.eip.common.core.utils.LogUtil;
...
public class CalendarUtil {
    ...
    public static int getBetweenHourNumber(Date startDate, Date endDate) {
        ...
        try {
            ...
            LogUtil.error("getBetweenHourNumber failed, startDate = " + startDate + ", " + "endDate = " + endDate,e);
        }
        return (int) timeNumber;
    }
    ...
    public static int getBetweenMonthNumber(Date startDate, Date endDate) {
        ...
        try {
            ...
            LogUtil.error("getBetweenMonthNumber failed, startDate = " + startDate + ", " + "endDate = " + endDate,e);
        }
        return result;
    }
    ...
    public static int getBetweenYearNumber(Date startDate, Date endDate) {
        ...
        try {
            ...
            LogUtil.error("getBetweenYearNumber failed, startDate = " + startDate + ", " + "endDate = " + endDate,e);
        }
        return result;
    }
