...
// * 基于2.0.0版本，实现基于自定义加解密方式，若用默认加解密方式，注释此类即可
// */
//public class DefaultConfig extends AbstractConfig implements RepositoryChangeListener {
//
//    //解密秘钥
//    public static String APOLLO_ENCRYPT_PRIVATE_KEY = "apollo.encrypt.private-key";
//    //加密秘钥
//    public static String APOLLO_ENCRYPT_PUBLIC_KEY = "apollo.encrypt.public-key";
//
...
//            logger.warn(
//                    "Could not load config for namespace {} from Apollo, please check whether the configs are " +
...
//        // propertyNames include system property and system env might cause some compatibility issues, though that
//        // looks like the correct implementation.
